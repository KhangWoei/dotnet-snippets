...
internal class UriDiscoveredNotificationHandler(ICrawlSourceFactory factory, ISeedQueue<Task<ICrawlSource>> seedQueue) : INotificationHandler<UriDiscoveredNotification>
{
